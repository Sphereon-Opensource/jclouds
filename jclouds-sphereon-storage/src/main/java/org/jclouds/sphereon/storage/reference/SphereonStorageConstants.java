...
public final class SphereonStorageConstants {
    ...
    public static final String DEFAULT_ENDPOIMT = String.format("https://gw.api.cloud.sphereon.com/bucket-storage/%s/", API_VERSION);
//    String.format("http://gw-dev.api.cloud.sphereon.com/bucket-storage/%s", API_VERSION);
